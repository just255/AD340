...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLongitude.setText("Press Location Button to Display Current Location");
        ...
        public boolean onMyLocationButtonClick() {
            ...
            getDeviceLocation();
            String lat = "Latitude: " + String.valueOf(mLastKnownLocation.getLatitude());
            String lon = "Longitude: " + String.valueOf(mLastKnownLocation.getLongitude());
            ...
            try {
                ...
                String completeAddress = "Address: " + address + " " + city + ", " + state + " " + postalCode;
                mLocation.setText(completeAddress);
            }catch (Exception e){
                e.printStackTrace();
            }
